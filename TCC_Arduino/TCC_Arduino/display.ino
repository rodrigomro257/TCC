...
void exibir_lcd_define_finais(){
  lcd.setCursor(0,0); // COLUNA 0, LINHA 0.
  lcd.print("DEFINIR FINAIS"); // IMPRIME TEXTO.
  lcd.setCursor(0,1); // COLUNA 0, LINHA 1.
  lcd.print("Finais ");
  lcd.setCursor(7,1); // COLUNA 0, LINHA 1.
  lcd.print(estados_finais[0]);
  lcd.setCursor(9,1); // COLUNA 0, LINHA 1.
  lcd.print(estados_finais[1]);
  lcd.setCursor(11,1); // COLUNA 0, LINHA 1.
  lcd.print(estados_finais[2]);
  lcd.setCursor(13,1); // COLUNA 0, LINHA 1.
  lcd.print(estados_finais[3]);
  lcd.setCursor(15,1); // COLUNA 0, LINHA 1.
